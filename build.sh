...
# TODO: needs edits afterwards
# generate the client for use by Rust code
# oas3-gen generate --input ./schema/openapi.json --output ./object_detector_v2/src/api_types.rs --enum-mode merge --verbose --visibility crate types
# oas3-gen generate --input ./schema/openapi.json --output ./object_detector_v2/src/api_client.rs --enum-mode merge --verbose --visibility crate client
