...
docker build --platform=linux/amd64 -t kube-registry:5000/camry-object-detector-v2:sm30 -f ./docker/object-detector-v2/Dockerfile --build-arg BASE_IMAGE=gocv/opencv:4.7.0-gpu-cuda-10 .
