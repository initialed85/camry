...
# docker build --progress=plain --platform=linux/amd64 -t initialed85/camry-api:latest -f ./docker/api/Dockerfile .
...
# docker build --progress=plain --platform=linux/amd64 -t initialed85/camry-object-detector:latest -f ./docker/object-detector/Dockerfile --build-arg BASE_IMAGE=pytorch/pytorch:2.4.0-cuda11.8-cudnn9-runtime .
