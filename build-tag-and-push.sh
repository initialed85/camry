...
GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build -o ./tmp/fix-thumbnails -trimpath -x ./cmd/fix_thumbnails
...
# note: was pytorch/pytorch:2.4.0-cuda11.8-cudnn9-runtime
