...
docker build --platform=linux/amd64 -t kube-registry:5000/camry-object-detector-v2:latest -f ./docker/object-detector-v2/Dockerfile --build-arg BASE_IMAGE=gocv/opencv:4.12.0-gpu-cuda-11.2.2 .
docker build --platform=linux/amd64 -t kube-registry:5000/camry-object-detector-v2:sm30 -f ./docker/object-detector-v2/Dockerfile.sm30 --build-arg BASE_IMAGE=gocv/opencv:4.7.0-gpu-cuda-10 .
...
docker image push kube-registry:5000/camry-object-detector-v2:latest
docker image push kube-registry:5000/camry-object-detector-v2:sm30
