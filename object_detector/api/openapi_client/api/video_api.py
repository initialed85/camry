...
class VideoApi:
    ...
    @validate_call
    def post_videos_object_detector_claim(
        self,
        primary_key: Annotated[StrictStr, Field(description="Path parameter primaryKey")],
        video_object_detector_claim_request: VideoObjectDetectorClaimRequest,
        depth: Annotated[Optional[StrictInt], Field(description="Query parameter depth")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        """post_videos_object_detector_claim


        :param primary_key: Path parameter primaryKey (required)
        :type primary_key: str
        :param video_object_detector_claim_request: (required)
        :type video_object_detector_claim_request: VideoObjectDetectorClaimRequest
        :param depth: Query parameter depth
        :type depth: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._post_videos_object_detector_claim_serialize(
            primary_key=primary_key,
            video_object_detector_claim_request=video_object_detector_claim_request,
            depth=depth,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_videos_object_detector_claim_with_http_info(
        self,
        primary_key: Annotated[StrictStr, Field(description="Path parameter primaryKey")],
        video_object_detector_claim_request: VideoObjectDetectorClaimRequest,
        depth: Annotated[Optional[StrictInt], Field(description="Query parameter depth")] = None,
    ...
    @validate_call
    def post_videos_object_detector_claim_without_preload_content(
        self,
        primary_key: Annotated[StrictStr, Field(description="Path parameter primaryKey")],
        video_object_detector_claim_request: VideoObjectDetectorClaimRequest,
        depth: Annotated[Optional[StrictInt], Field(description="Query parameter depth")] = None,
    ...
    def _post_videos_object_detector_claim_serialize(
        self,
        primary_key,
        ...
        # process the form parameters
        # process the body parameter
        if video_object_detector_claim_request is not None:
            _body_params = video_object_detector_claim_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/videos/{primaryKey}/object-detector-claim',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_videos_object_tracker_claim(
        self,
        primary_key: Annotated[StrictStr, Field(description="Path parameter primaryKey")],
        ...
        """post_videos_object_tracker_claim
        ...
        _param = self._post_videos_object_tracker_claim_serialize(
            primary_key=primary_key,
    ...
    @validate_call
    def post_videos_object_tracker_claim_with_http_info(
        self,
        primary_key: Annotated[StrictStr, Field(description="Path parameter primaryKey")],
        video_object_tracker_claim_request: VideoObjectTrackerClaimRequest,
        depth: Annotated[Optional[StrictInt], Field(description="Query parameter depth")] = None,
    ...
    @validate_call
    def post_videos_object_tracker_claim_without_preload_content(
        self,
        primary_key: Annotated[StrictStr, Field(description="Path parameter primaryKey")],
        video_object_tracker_claim_request: VideoObjectTrackerClaimRequest,
        depth: Annotated[Optional[StrictInt], Field(description="Query parameter depth")] = None,
    ...
    def _post_videos_object_tracker_claim_serialize(
        self,
        primary_key,
        ...
        # process the form parameters
        # process the body parameter
        if video_object_tracker_claim_request is not None:
            _body_params = video_object_tracker_claim_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/videos/{primaryKey}/object-tracker-claim',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
