 ...
 **object_detector_claimed_until__eq** | **datetime**| SQL &#x3D; operator | [optional] 
 **object_detector_claimed_until__ne** | **datetime**| SQL !&#x3D; operator | [optional] 
 **object_detector_claimed_until__gt** | **datetime**| SQL &gt; operator, may not work with all column types | [optional] 
 **object_detector_claimed_until__gte** | **datetime**| SQL &gt;&#x3D; operator, may not work with all column types | [optional] 
 **object_detector_claimed_until__lt** | **datetime**| SQL &lt; operator, may not work with all column types | [optional] 
 **object_detector_claimed_until__lte** | **datetime**| SQL &lt;&#x3D; operator, may not work with all column types | [optional] 
 **object_detector_claimed_until__in** | **datetime**| SQL IN operator, permits comma-separated values | [optional] 
 **object_detector_claimed_until__nin** | **datetime**| SQL NOT IN operator, permits comma-separated values | [optional] 
 **object_detector_claimed_until__notin** | **datetime**| SQL NOT IN operator, permits comma-separated values | [optional] 
 **object_detector_claimed_until__isnull** | **str**| SQL IS NULL operator, value is ignored (presence of key is sufficient) | [optional] 
 **object_detector_claimed_until__nisnull** | **str**| SQL IS NOT NULL operator, value is ignored (presence of key is sufficient) | [optional] 
 **object_detector_claimed_until__isnotnull** | **str**| SQL IS NOT NULL operator, value is ignored (presence of key is sufficient) | [optional] 
 **object_detector_claimed_until__l** | **str**| SQL LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__like** | **str**| SQL LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__nl** | **str**| SQL NOT LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__nlike** | **str**| SQL NOT LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__notlike** | **str**| SQL NOT LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__il** | **str**| SQL ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__ilike** | **str**| SQL ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__nil** | **str**| SQL NOT ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__nilike** | **str**| SQL NOT ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__notilike** | **str**| SQL NOT ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_detector_claimed_until__desc** | **str**| SQL ORDER BY _ DESC operator, value is ignored (presence of key is sufficient) | [optional] 
 **object_detector_claimed_until__asc** | **str**| SQL ORDER BY _ ASC operator, value is ignored (presence of key is sufficient) | [optional] 
 **object_tracker_claimed_until__eq** | **datetime**| SQL &#x3D; operator | [optional] 
 **object_tracker_claimed_until__ne** | **datetime**| SQL !&#x3D; operator | [optional] 
 **object_tracker_claimed_until__gt** | **datetime**| SQL &gt; operator, may not work with all column types | [optional] 
 **object_tracker_claimed_until__gte** | **datetime**| SQL &gt;&#x3D; operator, may not work with all column types | [optional] 
 **object_tracker_claimed_until__lt** | **datetime**| SQL &lt; operator, may not work with all column types | [optional] 
 **object_tracker_claimed_until__lte** | **datetime**| SQL &lt;&#x3D; operator, may not work with all column types | [optional] 
 **object_tracker_claimed_until__in** | **datetime**| SQL IN operator, permits comma-separated values | [optional] 
 **object_tracker_claimed_until__nin** | **datetime**| SQL NOT IN operator, permits comma-separated values | [optional] 
 **object_tracker_claimed_until__notin** | **datetime**| SQL NOT IN operator, permits comma-separated values | [optional] 
 **object_tracker_claimed_until__isnull** | **str**| SQL IS NULL operator, value is ignored (presence of key is sufficient) | [optional] 
 **object_tracker_claimed_until__nisnull** | **str**| SQL IS NOT NULL operator, value is ignored (presence of key is sufficient) | [optional] 
 **object_tracker_claimed_until__isnotnull** | **str**| SQL IS NOT NULL operator, value is ignored (presence of key is sufficient) | [optional] 
 **object_tracker_claimed_until__l** | **str**| SQL LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__like** | **str**| SQL LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__nl** | **str**| SQL NOT LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__nlike** | **str**| SQL NOT LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__notlike** | **str**| SQL NOT LIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__il** | **str**| SQL ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__ilike** | **str**| SQL ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__nil** | **str**| SQL NOT ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__nilike** | **str**| SQL NOT ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__notilike** | **str**| SQL NOT ILIKE operator, value is implicitly prefixed and suffixed with % | [optional] 
 **object_tracker_claimed_until__desc** | **str**| SQL ORDER BY _ DESC operator, value is ignored (presence of key is sufficient) | [optional] 
 **object_tracker_claimed_until__asc** | **str**| SQL ORDER BY _ ASC operator, value is ignored (presence of key is sufficient) | [optional] 
