...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.delete_video(primary_key)
...
# **get_video**
> GetVideos200Response get_video(primary_key)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_video(primary_key)
...
# **patch_video**
> GetVideos200Response patch_video(primary_key, video)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.patch_video(primary_key, video)
...
# **post_videos**
> GetVideos200Response post_videos(video)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.post_videos(video)
...
# **put_video**
> GetVideos200Response put_video(primary_key, video)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.put_video(primary_key, video)
